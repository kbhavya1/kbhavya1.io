...
--
-- Host: localhost
-- Generation Time: Nov 21, 2017 at 01:54 AM
...
CREATE TABLE `list` (
  ...
  `departure_time` time(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `list` (`train_no`, `train_name`, `source`, `destination`, `arrival_time`, `departure_time`) VALUES
(12391, 'shatabdi', 'ndls', 'lko', '18:16:00.00000', '16:25:00.00000'),
(12392, 'dabri', 'pnbe', 'lko', '16:17:00.00000', '05:26:00.00000');
...
INSERT INTO `trigger_test` (`feedback`, `rating`) VALUES
('Very Good', 0),
('Very Good', 0),
('Fair', 3),
('Very Good', 5),
...
--
DELIMITER $$
CREATE TRIGGER `Rating` BEFORE INSERT ON `trigger_test` FOR EACH ROW IF NEW.feedback ='Very Good' THEN
   SET NEW.rating=5 ;
   ELSEIF NEW.feedback='Good' THEN
   SET NEW.rating=4;
   ELSEIF NEW.feedback='Fair' THEN
   SET NEW.rating=3;
   ELSEIF NEW.feedback='Average' THEN
   SET NEW.rating=2;
   ELSEIF NEW.feedback='Poor' THEN
   SET NEW.rating=1;
